...
Future<Provider> fetchPost() async {
  final response = await http.get(
      'http://pax-user.herokuapp.com/provider_info_by_category?providerId=&categoryId=',
                        ...
                        Row(
                          children: <Widget>[
                            Container(
                              ...
                              child: Text(
                                "R\$" +
                                    providerInfo.minPrice.toString() +
                                    " a " +
                                    "R\$" +
                                    providerInfo.maxPrice.toString(),
                                style: TextStyle(
